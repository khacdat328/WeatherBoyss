...
btn.addEventListener('click',function(){
    ...
    { 
        ...
        document.getElementsByClassName('map-contain2')[0]
            .getElementsByClassName('radar')[0]
            .setAttribute('src','https://embed.windy.com/embed2.html?lat='+lat+'&lon='+lon+'&zoom=9&level=surface&overlay=temp&product=ecmwf&menu=&message=&marker=true&calendar=now&pressure=&type=map&location=coordinates&metricWind=default&metricTemp=default&radarRange=-1')
    })
})